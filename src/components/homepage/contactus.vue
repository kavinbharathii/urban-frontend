...
export default {
    ...
    methods: {
        send() {
            axios.post(
                'https://servbees.netlify.app/api/data',
                this.msgData
            ).then(response => {
                console.log('hi')
...
<template>
    <div>
        ...
        <div class="main">
            <div class="left">
                <div class="logo">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="250" height="166.66"
                        viewBox="0 0 1050.8619 704.35284" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path
                            ...
                            transform="translate(-74.56905 -97.82358)" fill="#e5e5e5" />
                        <path
                            ...
                            transform="translate(-74.56905 -97.82358)" fill="#2f2e41" />
                        <rect id="effaf695-3865-40c6-8918-ced0238239c2" data-name="Rectangle 25" width="286.651"
                            height="324.35501" fill="#e6e6e6" />
                        <rect id="f33d627f-c769-4bde-9d74-ef156faf640e" data-name="Rectangle 25-2" x="5.111" y="6.86201"
                            width="275.92801" height="310.63199" fill="#fff" />
                        <circle id="b5fd4af9-5b07-4da2-8ccf-5b3d4ac887f6" data-name="Ellipse 116" cx="143.326"
                            cy="290.98201" r="15.467" fill="#e6e6e6" />
                        <rect id="f05405a0-af73-4807-bbd1-d761cdd06c65" data-name="Rectangle 31" x="51.876" y="116.81901"
                            width="88.837" height="9.088" fill="#e6e6e6" />
                        <rect id="a05e4a04-50b7-46b0-b842-8db21044ae7a" data-name="Rectangle 32" x="51.876" y="144.05199"
                            width="134.07899" height="9.088" fill="#fc3171" />
                        <rect id="bdce3bac-3998-4a72-bc14-4aa79023038d" data-name="Rectangle 38" x="51.876" y="171.45602"
                            width="120.918" height="9.088" fill="#e6e6e6" />
                        <rect id="e1177af0-2f80-4461-b67e-43945f3b6fee" data-name="Rectangle 39" x="51.876" y="198.13601"
                            width="186.72301" height="9.088" fill="#fc3171" />
                        <rect id="b290cdc3-2096-427b-bfd4-6b657da823ea" data-name="Rectangle 40" x="53.81699" y="223.54501"
                            width="152.175" height="9.088" fill="#e6e6e6" />
                        <g id="b96c6486-fa38-4cba-8e5e-13dca7f44a0c" data-name="Group 52">
                            <path id="b0fbfc35-67c9-42b4-b2fe-33d0d7288754-96" data-name="Path 846"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#9f616a" />
                            <path id="a6a8f1c9-3ab8-4f6f-ba9b-45acc2f7af89-97" data-name="Path 852"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#fc3171" />
                            <path id="fc06e97d-785e-4845-9aa0-60a5889f9ce3-98" data-name="Path 853"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#fc3171" />
                            <path id="b248559b-61d8-49e2-8eef-81cc9521c19e-99" data-name="Path 855"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#9f616a" />
                            <path id="b0e9bc84-32e8-4599-bd8d-d35670d3692b-100" data-name="Path 856"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#fc3171" />
                            <path id="b58b0f1b-b11b-4f57-8de2-a939101b4938-101" data-name="Path 857"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#2f2e41" />
                            <circle id="ba54abe3-4119-45e5-b5c1-150877d750f7" data-name="Ellipse 148" cx="716.54794"
                                cy="218.96508" r="67.405" fill="#9f616a" />
                            <path id="b6bcc4bf-1738-426f-8fbf-3ee273a728b5-102" data-name="Path 858"
                                ...
                                transform="translate(-74.56905 -97.82358)" fill="#2f2e41" />
                            <path id="be96ad09-85ff-4345-abef-5a49918f7c18-103" data-name="Path 859"
                        ...
                        <g id="b2dad932-78e1-44e1-9682-073c8202f887" data-name="Group 51">
                            <path id="e043db59-b600-449e-8c52-e1eb73379667-104" data-name="Path 341"
                        ...
                        <path id="bcfa45dc-2c5a-4ac5-8376-9a2a23e225d0-105" data-name="Path 842"
                            ...
                            transform="translate(-74.56905 -97.82358)" fill="#3f3d56" />
                    </svg>
                </div>
                <div class="loc">
            ...
            <div class="right">
                ...
                <div class="name-email">
                    <div class="name"><input type="text" required v-model="this.msgData.fullName"><span>Full Name</span></div>
                    <div class="email"><input type="email" required v-model="this.msgData.emailAddress"><span>Email Address</span></div>
                </div>
                <div class="text-area-div">
                    <textarea name="message" placeholder="Your Message" required v-model="this.msgData.msg"></textarea>
                </div>
                <div class="btn">
                    <button @click="send()">
                        Let's get in touch
